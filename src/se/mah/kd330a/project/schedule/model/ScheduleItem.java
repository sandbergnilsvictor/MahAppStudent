...
public class ScheduleItem implements Serializable{
	...
	public ScheduleItem(VEvent v) {
		...
		if (summary.indexOf("Coursegrp: ")!=-1){
			courseName = summary.substring(summary.indexOf("Coursegrp: ")+12, summary.indexOf("Coursegrp: ") +17);
		}
		if (summary.indexOf("Sign: ")!=-1){
			teacherID = summary.substring(summary.indexOf("Sign: ")+6, summary.indexOf("Sign: ") +12);
		}
		//Log.i("Schedule",v.getSummary().getValue()); To look at the Summary 
	}
